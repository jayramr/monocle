```{r}
data <- readRDS('/Users/nr83/Downloads/integrated.rds')
...
Idents(data) <- id
  ...
  #data$monocle3_pseudotime[data$monocle3_pseudotime == NA] <- 0 
...
```{r}
data <- readRDS('/Users/nr83/Downloads/Project1_seuratObj.rds')
